const phrases_1984 = {
  en: [
    ...
    'His small but childish handwriting straggled up and down the page, shedding first its capital letters and finally even its full stops: April 4th, 1984.',
    ...
    'In the Two Minutes Hate he could not help sharing in the general delirium, but this sub-human chanting of \'B-B!...B-B!\'',
    ...
    'Chapter 2 As he put his hand to the door-knob Winston saw that he had left the diary open on the table.',
    ...
    'It\'s got blocked up and, \' It was Mrs Parsons, the wife of a neighbour on the same floor.',
    '(\'Mrs\' was a word somewhat discountenanced by the Party, you were supposed to call everyone \'comrade\', but with some women one used it instinctively.) She was a woman of about thirty, but looking much older.',
    ...
    'Perhaps the children, \' There was a trampling of boots and another blast on the comb as the children charged into the living-room.',
    ...
    'Every few minutes the old man kept repeating: \'We didn\'t ought to \'ave trusted \'em.',
    ...
    'Chapter 4 With the deep, unconscious sigh which not even the nearness of the telescreen could prevent him from uttering when his day\'s work started, Winston pulled the speakwrite towards him, blew the dust from its mouthpiece, and put on his spectacles.',
    ...
    'Chapter 5 In the low-ceilinged canteen, deep underground, the lunch queue jerked slowly forward.',
    ...
    '\'Not one!\'',
    'said Winston with a sort of guilty haste.',
    ...
    '\'Nex\', please!\'',
    'yelled the white-aproned prole with the ladle.',
    ...
    'Do you know that Newspeak is the only language in the world whose vocabulary gets smaller every year?\' Winston did know that, of course.',
    'He smiled, sympathetically he hoped, not trusting himself to speak.',
    'Syme bit off another fragment of the dark-coloured bread, chewed it briefly, and went on: \'Don\'t you see that the whole aim of Newspeak is to narrow the range of thought?',
    ...
    'Parsons went on triumphantly: \'My kid made sure he was some kind of enemy agent, might have been dropped by parachute, for instance.',
    ...
    'Pretty smart for a nipper of seven, eh?\' \'What happened to the man?\' said Winston.',
    ...
    '\'By the way, Smith old boy, I suppose you haven\'t got any razor blades you can let me have?\' \'Not one,\' said Winston.',
    ...
    'Still, gives \'em the right idea, eh?\' At this moment the telescreen let out a piercing whistle.',
    ...
    'Chapter 6 Winston was writing in his diary: It was three years ago.',
    ...
    'He drew his breath and went on writing: I went with her through the doorway and across a backyard into a basement kitchen.',
    ...
    'He picked up his pen again and wrote: She threw herself down on the bed, and at once, without any kind of preliminary in the most coarse, horrible way you can imagine, pulled up her skirt.',
    ...
    'When I saw her in the light, After the darkness the feeble light of the paraffin lamp had seemed very bright.',
    ...
    'He wrote hurriedly, in scrabbling handwriting: When I saw her in the light she was quite an old woman, fifty years old at least.',
    ...
    'It\'s started!',
    'he had thought.',
    'A riot! The proles are breaking loose at last!',
    ...
    'The chief of all the capitalists was called the King, and, But he knew the rest of the catalogue.',
    ...
    'Chapter 8 From somewhere at the bottom of a passage the smell of roasting coffee, real coffee, not Victory Coffee, came floating out into the street.',
    ...
    'It\'s easy to criticize," I says, "but you ain\'t got the same problems as what I got."\' \'Ah,\' said the other, \'that\'s jest it.',
    ...
    'An\' I tell you, no number ending in seven, \' \'Yes, a seven \'AS won!',
    ...
    'An\' I tell you, no number, \' \'Oh, pack it in!\'',
    'said the third man.',
    ...
    'Were things better than they are now, or were they worse?\' Hurriedly, lest he should have time to become frightened, he descended the steps and crossed the narrow street.',
    ...
    '\'You telling me you ain\'t got a pint mug in the \'ole bleeding boozer?\' \'And what in hell\'s name IS a pint?\' said the barman, leaning forward with the tips of his fingers on the counter.',
    '\'\'Ark at \'im!',
    ...
    'They lived in great gorgeous houses with thirty servants, they rode about in motor-cars and four-horse carriages, they drank champagne, they wore top hats, \' The old man brightened suddenly.',
    '\'Top \'ats!\'',
    ...
    'Every capitalist went about with a gang of lackeys who, \' The old man brightened again.',
    '\'Lackeys!\'',
    'he said. \'Now there\'s a word I ain\'t \'eard since ever so long.',
    'Lackeys! That reg\'lar takes me back, that does.',
    ...
    'Is it a fact, for instance, that you had to call them "Sir" and take off your cap when you passed them?\' The old man appeared to think deeply.',
    ...
    '\'And was it usual, I\'m only quoting what I\'ve read in history books, was it usual for these people and their servants to push you off the pavement into the gutter?\' \'One of \'em pushed me once,\' said the old man.',
    ...
    'I say, "Ju think you\'ve bought the bleeding pavement?" \'E says, "I\'ll twist your bloody \'ead off if you get fresh with me." I says, "You\'re drunk.',
    ...
    'Well, I was young in them days, and I was going to \'ave fetched \'im one, only, \' A sense of helplessness took hold of Winston.',
    ...
    'If you could choose, would you prefer to live then or now?\' The old man looked meditatively at the darts board.',
    ...
    'Or did you just want to look round?\' \'I was passing,\' said Winston vaguely.',
    '\'I just looked in.',
    ...
    'But who cares about genuine antiques nowadays, even the few that\'s left?\' Winston immediately paid over the four dollars and slid the coveted thing into his pocket.',
    ...
    'How it goes on I don\'t remember, but I do know it ended up, "Here comes a candle to light you to bed, Here comes a chopper to chop off your head." It was a kind of a dance.',
    ...
    'Like a leaden knell the words came back at him: WAR IS PEACE FREEDOM IS SLAVERY IGNORANCE IS STRENGTH PART TWO Chapter 1 It was the middle of the morning, and Winston had left the cubicle to go to the lavatory.',
    ...
    '\'You\'re hurt?\' he said.',
    '\'It\'s nothing.',
    'My arm. It\'ll be all right in a second.\'',
    ...
    '\'Where can we meet?\' \'Victory Square, near the monument.\'',
    ...
    'Go to Paddington Station, \' With a sort of military precision that astonished him, she outlined the route that he was to follow.',
    ...
    '\'Yes.\' \'You turn left, then right, then left again.',
    'And the gate\'s got no top bar.\'',
    '\'Yes. What time?\' \'About fifteen.',
    'You may have to wait.',
    'I\'ll get there by another way.',
    'Are you sure you remember everything?\' \'Yes.\'',
    ...
    'Chapter 2 Winston picked his way up the lane through dappled light and shade, stepping out into pools of gold wherever the boughs parted.',
    ...
    '\'Now that you\'ve seen what I\'m really like, can you still bear to look at me?\' \'Yes, easily.\'',
    ...
    'Tell me, what did you think of me before that day I gave you the note?\' He did not feel any temptation to tell lies to her.',
    ...
    'But from your general appearance, merely because you\'re young and fresh and healthy, you understand, I thought that probably, \' \'You thought I was a good Party member.',
    'Pure in word and deed.',
    'Banners, processions, slogans, games, community hikes all that stuff.',
    'And you thought that if I had a quarter of a chance I\'d denounce you as a thought-criminal and get you killed off?\' \'Yes, something of that kind.',
    ...
    'What could you see to attract you in a man like me?\' \'It was something in your face.',
    ...
    '\'With members of the Inner Party?\' \'Not with those swine, no.',
    ...
    'Do you understand that?\' \'Yes, perfectly.\'',
    ...
    '\'You like doing this?',
    'I don\'t mean simply me: I mean the thing in itself?\' \'I adore it.\'',
    ...
    'Chapter 3 \'We can come here once again,\' said Julia.',
    ...
    'Meaning naturally orthodox, incapable of thinking a bad thought?\' \'No, I didn\'t know the word, but I know the kind of person, right enough.\'',
    ...
    '\'How did you know that?\' \'I\'ve been at school too, dear.',
    ...
    'The way she put it was: \'When you make love you\'re using up energy; and afterwards you feel happy and don\'t give a damn for anything.',
    ...
    'If you\'re happy inside yourself, why should you get excited about Big Brother and the Three-Year Plans and the Two Minutes Hate and all the rest of their bloody rot?\' That was very true, he thought.',
    ...
    'Do you see they\'re two different colours?\' She had already turned to go, but she did rather fretfully come back for a moment.',
    ...
    '\'Then why are you sorry you didn\'t do it?\' \'Only because I prefer a positive to a negative.',
    ...
    'Don\'t you like THIS?\' She twisted herself round and pressed her bosom against him.',
    ...
    'Chapter 4 Winston looked round the shabby little room above Mr Charrington\'s shop.',
    ...
    'Whenever her mouth was not corked with clothes pegs she was singing in a powerful contralto: It was only an \'opeless fancy.',
    'It passed like an Ipril dye, But a look an\' a word an\' the dreams they stirred!',
    ...
    'I had to wrap a bit of sacking round it, because, \' But she did not need to tell him why she had wrapped it up.',
    ...
    '\'How did you manage to get hold of all these things?\' \'It\'s all Inner Party stuff.',
    ...
    'We\'ve got an hour.',
    'What time do they cut the lights off at your flats?\' \'Twenty-three thirty.\'',
    ...
    'And the nasty thing is that the brutes always, \' \'DON\'T GO ON!\'',
    'said Winston, with his eyes tightly shut.',
    '\'Dearest! You\'ve gone quite pale.',
    'What\'s the matter?',
    'Do they make you feel sick?\' \'Of all horrors in the world, a rat!\'',
    ...
    '\'And that picture over there\', she nodded at the engraving on the opposite wall, \'would that be a hundred years old?\' \'More.',
    ...
    'The fragment of rhyme that Mr Charrington had taught him came back into his head, and he added half-nostalgically: "Oranges and lemons, say the bells of St Clement\'s!" To his astonishment she capped the line: \'You owe me three farthings, say the bells of St Martin\'s, When will you pay me?',
    'say the bells of Old Bailey, \' \'I can\'t remember how it goes on after that.',
    'But anyway I remember it ends up, "Here comes a candle to light you to bed, here comes a chopper to chop off your head!"\' It was like the two halves of a countersign.',
    ...
    'People are being killed off all the time, aren\'t they?\' He tried to make her understand.',
    ...
    '\'And what good was that?\' \'It was no good, because I threw it away a few minutes later.',
    ...
    'What could you have done with it even if you had kept it?\' \'Not much, perhaps.',
    'But it was evidence.',
    ...
    'Chapter 6 It had happened at last.',
    ...
    'You take a scholarly interest in Newspeak, I believe?\' Winston had recovered part of his self-possession.',
    ...
    'Have you seen the tenth edition of the Newspeak Dictionary?\' \'No,\' said Winston.',
    ...
    '\'Yes. But the real point of the story, \' From her breathing it was evident that she was going off to sleep again.',
    ...
    '\'Has it ever occurred to you,\' he said, \'that the best thing for us to do would be simply to walk out of here before it\'s too late, and never see each other again?\' \'Yes, dear, it has occurred to me, several times.',
    ...
    '\'You can turn it off!\'',
    'he said. \'Yes,\' said O\'Brien, \'we can turn it off.',
    ...
    '\'That thing is really turned off?\' \'Yes, everything is turned off.',
    'We are alone.\'',
    ...
    'Is it real?',
    'It is not simply an invention of the Thought Police?\' \'No, it is real.',
    ...
    'In general terms, what are you prepared to do?\' \'Anything that we are capable of,\' said Winston.',
    ...
    '\'You are prepared to commit suicide, if and when we order you to do so?\' \'Yes.\'',
    '\'You are prepared, the two of you, to separate and never see one another again?\' \'No!\'',
    'broke in Julia.',
    ...
    'He turned himself toward Julia and added in a voice with somewhat more expression in it: \'Do you understand that even if he survives, it may be as a different person?',
    ...
    'O\'Brien went on: \'You will have heard rumours of the existence of the Brotherhood.',
    ...
    '\'I assume that you have a hiding-place of some kind?\' Winston explained about the room over Mr Charrington\'s shop.',
    ...
    '\'As a rule, yes.\'',
    '\'What is it like?\' \'Black, very shabby.',
    'With two straps.\'',
    ...
    'At some time during the day, in the street, a man will touch you on the arm and say "I think you have dropped your brief-case." The one he gives you will contain a copy of Goldstein\'s book.',
    'You will return it within fourteen days.\'',
    'They were silent for a moment.',
    '\'There are a couple of minutes before you need go,\' said O\'Brien.',
    '\'We shall meet again, if we do meet again, \' Winston looked up at him.',
    ...
    'Almost at random he said: \'Did you ever happen to hear an old rhyme that begins "Oranges and lemons, say the bells of St Clement\'s"?\' Again O\'Brien nodded.',
    ...
    'say the bells of Old Bailey, When I grow rich, say the bells of Shoreditch.\'',
    ...
    'Chapter 9 Winston was gelatinous with fatigue.',
    ...
    'He went on reading: Chapter III War is Peace The splitting up of the world into three great super-states was an event which could be and indeed was foreseen before the middle of the twentieth century.',
    ...
    '\'You too. All members of the Brotherhood have to read it.\'',
    ...
    'Go on. It\'s marvellous.\'',
    'He continued reading: The aims of these three groups are entirely irreconcilable.',
    ...
    'As for the problem of over-production, which has been latent in our society since the development of machine technique, it is solved by the device of continuous warfare (see Chapter III), which is also useful in keying up public morale to the necessary pitch.',
    ...
    'As we have seen.',
    'the mystique of the Party, and above all of the Inner Party, depends upon DOUBLETHINK But deeper than this lies the original motive, the never-questioned instinct that first led to the seizure of power and brought DOUBLETHINK, the Thought Police, continuous warfare, and all the other necessary paraphernalia into existence afterwards.',
    ...
    'He lay dozing for a while; then the usual deep-lunged singing struck up from the yard below: \'It was only an \'opeless fancy, It passed like an Ipril dye, But a look an\' a word an\' the dreams they stirred They \'ave stolen my \'eart awye!\'',
    ...
    'Damn! The stove\'s gone out and the water\'s cold.\'',
    ...
    'The indefatigable voice sang on: \'They sye that time \'eals all things, They sye you can always forget; But the smiles an\' the tears acrorss the years They twist my \'eart-strings yet!\'',
    ...
    '\'Do you remember,\' he said, \'the thrush that sang to us, that first day, at the edge of the wood?\' \'He wasn\'t singing to us,\' said Julia.',
    ...
    'PART THREE Chapter 1 He did not know where he was.',
    ...
    '\'Ah, Smith!\'',
    'he said. \'You too!\'',
    '\'What are you in for?\' \'To tell you the truth, \' He sat down awkwardly on the bench opposite Winston.',
    ...
    'I could not help it!\'',
    'he added almost indignantly, raising his face to look at Winston.',
    ...
    '\'Has it ever occurred to you,\' he said, \'that the whole history of English poetry has been determined by the fact that the English language lacks rhymes?\' No, that particular thought had never occurred to Winston.',
    ...
    '\'YOU here!\'',
    'he said. Parsons gave Winston a glance in which there was neither interest nor surprise, but only misery.',
    ...
    'cried Parsons with a servile glance at the telescreen.',
    '\'You don\'t think the Party would arrest an innocent man, do you?\' His frog-like face grew calmer, and even took on a slightly sanctimonious expression.',
    ...
    'Do you know what they heard me saying?\' He sank his voice, like someone who is obliged for medical reasons to utter an obscenity.',
    ...
    '"Thank you," I\'m going to say, "thank you for saving me before it was too late."\' \'Who denounced you?\' said Winston.',
    ...
    '\'Comrade! Officer!\'',
    'he cried. \'You don\'t have to take me to that place!',
    ...
    '\'That\'s the one you ought to be taking, not me!\'',
    'he shouted.',
    ...
    'It might fall anywhere; on the crown, on the tip of the ear, on the upper arm, on the elbow, The elbow!',
    ...
    'Chapter 2 He was lying on something that felt like a camp bed, except that it was higher off the ground and that he was fixed down in some way so that he could not move.',
    ...
    'That is what you are thinking, is it not, Winston?\' Winston did not answer.',
    ...
    '\'With Eastasia.',
    'Good. And Oceania has always been at war with Eastasia, has it not?\' Winston drew in his breath.',
    ...
    '\'Is it your opinion, Winston, that the past has real existence?\' Again the feeling of helplessness descended upon Winston.',
    ...
    'Is there somewhere or other a place, a world of solid objects, where the past is still happening?\' \'No.\'',
    '\'Then where does the past exist, if at all?\' \'In records.',
    'It is written down.\'',
    '\'In records.',
    'And, ?\' \'In the mind.',
    'In human memories.\'',
    ...
    'Then we control the past, do we not?\' \'But how can you stop people remembering things?\' cried Winston again momentarily forgetting the dial.',
    '\'It is involuntary.',
    ...
    'Four!\' The needle must have risen again, but he did not look at it.',
    ...
    '\'Which do you wish: to persuade me that you see five, or really to see them?\' \'Really to see them.\'',
    '\'Again,\' said O\'Brien.',
    ...
    '\'Do you know how long you have been here?\' \'I don\'t know.',
    'Days, weeks, months, I think it is months.\'',
    '\'And why do you imagine that we bring people to this place?\' \'To make them confess.\'',
    '\'No, that is not the reason.',
    'Try again.\'',
    '\'To punish them.\'',
    '\'No!\' exclaimed O\'Brien.',
    'His voice had changed extraordinarily, and his face had suddenly become both stern and animated.',
    '\'No! Not merely to extract your confession, not to punish you.',
    ...
    'Do you understand what I mean by that?\' He was bending over Winston.',
    ...
    'That is what you were thinking, was it not?\' \'Yes,\' said Winston.',
    ...
    '\'It is switched off.',
    'What is your first question?\' \'What have you done with Julia?\' said Winston.',
    ...
    '\'You tortured her?\' O\'Brien left this unanswered.',
    ...
    'In that sense, does Big Brother exist?\' \'It is of no importance.',
    'He exists.\'',
    '\'Will Big Brother ever die?\' \'Of course not.',
    'How could he die?',
    'Next question.\'',
    '\'Does the Brotherhood exist?\' \'That, Winston, you will never know.',
    ...
    'At the thought the words burst out of him: \'What is in Room 101?\' The expression on O\'Brien\'s face did not change.',
    'He answered drily: \'You know what is in Room 101, Winston.',
    ...
    'Chapter 3 \'There are three stages in your reintegration,\' said O\'Brien.',
    ...
    'Did it tell you anything that you did not know already?\' \'You have read it?\' said Winston.',
    '\'I wrote it.',
    'That is to say, I collaborated in writing it.',
    'No book is produced individually, as you know.\'',
    '\'Is it true, what it says?\' \'As description, yes.',
    ...
    'He pulled the lever back and continued: \'Now I will tell you the answer to my question.',
    'It is this.',
    ...
    'Now do you begin to understand me?\' Winston was struck, as he had been struck before, by the tiredness of O\'Brien\'s face.',
    ...
    'Do you die when you cut your fingernails?\' He turned away from the bed and began strolling up and down again, one hand in his pocket.',
    ...
    'And there are disease, pain, death, \' O\'Brien silenced him by a movement of his hand.',
    ...
    'O\'Brien continued as though answering a spoken objection: \'For certain purposes, of course, that is not true.',
    ...
    'He paused, and for a moment assumed again his air of a schoolmaster questioning a promising pupil: \'How does one man assert his power over another, Winston?\' Winston thought.',
    ...
    '\'You can\'t!\'',
    'he said weakly.',
    '\'What do you mean by that remark, Winston?\' \'You could not create such a world as you have just described.',
    'It is a dream.',
    'It is impossible.\'',
    '\'Why?\' \'It is impossible to found a civilization on fear and hatred and cruelty.',
    'It would never endure.\'',
    '\'Why not?\' \'It would have no vitality.',
    ...
    'Or any reason why it should?\' \'No.',
    'I believe it.',
    ...
    'His manner changed and he said more harshly: \'And you consider yourself morally superior to us, with our lies and our cruelty?\' \'Yes, I consider myself superior.\'',
    ...
    'What do you think of your own face?\' He seized Winston\'s shoulder and spun him round so that he was facing him.',
    '\'Look at the condition you are in!\'',
    'he said. \'Look at this filthy grime all over your body.',
    ...
    'He paused, and then went on: \'We have beaten you, Winston.',
    ...
    'Can you think of a single degradation that has not happened to you?\' Winston had stopped weeping, though the tears were still oozing out of his eyes.',
    ...
    'Only, ! The pencil felt thick and awkward in his fingers.',
    'He began to write down the thoughts that came into his head.',
    'He wrote first in large clumsy capitals: FREEDOM IS SLAVERY Then almost without a pause he wrote beneath it: TWO AND TWO MAKE FIVE But then there came a sort of check.',
    ...
    'He had heard himself cry aloud: \'Julia!',
    'Julia! Julia, my love!',
    'Julia!\' For a moment he had had an overwhelming hallucination of her presence.',
    ...
    'Tell me, Winston, and remember, no lies: you know that I am always able to detect a lie, tell me, what are your true feelings towards Big Brother?\' \'I hate him.\'',
    '\'You hate him.',
    'Good. Then the time has come for you to take the last step.',
    'You must love Big Brother.',
    'It is not enough to obey him: you must love him.\'',
    'He released Winston with a little push towards the guards.',
    '\'Room 101,\' he said.',
    'Chapter 5 At each stage of his imprisonment he had known, or seemed to know, whereabouts he was in the windowless building.',
    ...
    'What is it that you want me to do?\' O\'Brien made no direct answer.',
    ...
    'How can I do it if I don\'t know what it is?\' O\'Brien picked up the cage and brought it across to the nearer table.',
    ...
    'Not me! Julia!',
    'Not me!\' He was falling backwards, into enormous depths, away from the rats.',
    ...
    'Chapter 6 The Chestnut Tree was almost empty.',
    ...
    'Almost unconsciously he traced with his finger in the dust on the table: 2+2=5 \'They can\'t get inside you,\' she had said.',
    ...
    'Check. But it was evidently not the right move, because, Uncalled, a memory floated into his mind.',
    ...
    'THE END APPENDIX.',
    'The Principles of Newspeak Newspeak was the official language of Oceania and had been devised to meet the ideological needs of Ingsoc, or English Socialism.',
    ...
    '[Compound words such as SPEAKWRITE, were of course to be found in the A vocabulary, but these were merely convenient abbreviations and had no special ideological colour.] They consisted of two or more words, or portions of words, welded together in an easily pronounceable form.',
    ...
    'that all men are of equal size, weight, or strength.',
    ...
    'It was chiefly in order to allow time for the preliminary work of translation that the final adoption of Newspeak had been fixed for so late a date as 2050. THE END'
  ],
  pt: [
